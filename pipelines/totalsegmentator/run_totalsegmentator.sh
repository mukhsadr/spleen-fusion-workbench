...
Usage:
  ...
  run_totalseg_cpu.sh run --input <input.nii|input.nii.gz> --output <output_dir> [--task spleen] [--fast]
  run_totalseg_cpu.sh all --input <input.nii|input.nii.gz> --output <output_dir> [--task spleen] [--fast] [--with-sudo-deps]
...
Options:
  ...
  --task <name>             TotalSegmentator task (default: spleen)
  --fast                    Add --fast flag
